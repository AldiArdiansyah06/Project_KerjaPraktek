                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="{{ url('about') }}" class="nav-item nav-link">Tentang Perusahaan</a>
                            <a href="{{ url('contact') }}" class="nav-item nav-link">Kontak</a>
                            <a href="{{ url('selflearning') }}" class="nav-item nav-link">Self Learning</a>
                            <a href="{{ url('visimisi') }}" class="nav-item nav-link">Visi Dan Misi</a>
                        </div>
                        <!-- Profil -->
                        <div class="btn-group">
                            <button type="button" class="btn bg-transparent border-0" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                <img src="https://via.placeholder.com/120" class="navbar-profile" alt="Profile">
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <label class="upload-btn" for="upload">Ubah Profile</label>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-contact">
                            <h2>Kontak Kantor</h2>
                            <p><i class="fa fa-map-marker-alt"></i> Jl. Letkol Iskandar, Palembang</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="newsletter">
                            ...
                            <p class="mt-3">PT. Lematang adalah jasa sewa alat berat di Palembang</p>
                        </div>
                    </div>
                </div>
            </div>
